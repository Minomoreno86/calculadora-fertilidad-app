...
export const PATHOLOGIES_DATABASE: Record<string, PathologyDefinition> = {
  ...
  endometrialPolyps: {
    ...
    diagnosticCriteria: [
      ...
      '• SIS (Saline Infusion Sonohysterography): mayor sensibilidad pequeños/múltiples',
  ...
  tubalObstruction: {
    ...
    diagnosticCriteria: [
      ...
      '• HyCoSy (Hysterosalpingo-Contrast-Sonography): evaluación permeabilidad tubárica',
