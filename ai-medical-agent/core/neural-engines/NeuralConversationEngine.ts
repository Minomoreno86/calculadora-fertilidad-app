...
import { MedicalPattern, NeuralAnalysis } from './NeuralPatternRecognition';
...
export interface ConversationContext {
  ...
  emotionalState: 'anxious' | 'hopeful' | 'worried' | 'determined' | 'neutral';
  understandingLevel: 'basic' | 'intermediate' | 'advanced';
  preferredCommunicationStyle: 'empathetic' | 'direct' | 'detailed' | 'reassuring';
}
