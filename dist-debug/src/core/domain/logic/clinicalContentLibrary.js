...
export const clinicalContentLibrary = {
    // ===================================================================
    // FACTORES INDIVIDUALES (Basado en "PARAMETROS FASE 1.docx")
    // ===================================================================
    // --- Edad ---
    EDAD_OPT: {
        explanation: 'Tu edad se encuentra en un rango óptimo de fertilidad. La edad es el factor predictivo más robusto en fertilidad. [cite: 79]',
        recommendations: ['Continúa con intento natural hasta 12 meses. [cite: 82]'],
        sources: ['PMID: 37004868 [cite: 84]', 'PMID: 32215375 [cite: 85]'],
    },
    EDAD_LIG_RED: {
        explanation: 'Tu fertilidad se encuentra ligeramente reducida debido a la edad. La edad es el factor predictivo más robusto en fertilidad. [cite: 79]',
        recommendations: ['Considerar evaluación si no hay embarazo en 6 meses. [cite: 82]'],
        sources: ['PMID: 37004868 [cite: 84]'],
    },
    EDAD_MOD_RED: {
        explanation: 'Tu fertilidad está moderadamente reducida debido a la edad. A partir de los 35 años se acelera el declive de fertilidad[cite: 81].',
        recommendations: ['Evaluación inmediata, considerar FIV si hay otros factores. [cite: 83]'],
        sources: ['PMID: 37004868 [cite: 84]', 'PMID: 32215375 [cite: 85]'],
    },
    EDAD_ALTO_RIESGO: {
        explanation: 'Tu edad representa un alto riesgo para la fertilidad. Después de los 40 las tasas de embarazo espontáneo y por FIV se reducen drásticamente[cite: 81].',
        recommendations: ['Evaluación inmediata, considerar FIV como primera línea. [cite: 83]'],
        sources: ['PMID: 37004868 [cite: 84]', 'PMID: 32215375 [cite: 85]'],
    },
    EDAD_MUY_ALTO_RIESGO: {
        explanation: 'Tu edad representa un muy alto riesgo para la fertilidad. Las tasas de embarazo son muy bajas. [cite: 81]',
        recommendations: ['Consejo genético, FIV con PGT-A o considerar ovodonación. [cite: 83]'],
        sources: ['PMID: 37004868 [cite: 84]'],
    },
    EDAD_CRITICA: {
        explanation: 'Tu edad (>42 años) presenta un riesgo crítico para la fertilidad con óvulos propios. La probabilidad es extremadamente baja. [cite: 78]',
        recommendations: ['FIV con PGT-A o ovodonación; evaluación urgente. [cite: 83]'],
        sources: ['PMID: 37004868 [cite: 84]'],
    },
    // --- IMC ---
    IMC_BAJO: {
        explanation: 'Tu Índice de Masa Corporal (IMC) indica bajo peso. Tanto el bajo peso como el sobrepeso/obesidad alteran el eje hipotálamo-hipófisis-ovario, afectando la ovulación, la implantación y aumentando el riesgo de pérdida gestacional. [cite: 87]',
        recommendations: [
    ...
    IMC_SOBREPESO: {
        explanation: 'Tu IMC indica sobrepeso. Puede afectar la ovulación, la implantación y aumentar el riesgo de pérdida gestacional. [cite: 87]',
        recommendations: [
    ...
    IMC_OBESIDAD_I: {
        explanation: 'Tu IMC indica Obesidad Clase I. Esto puede alterar la ovulación, la implantación y la calidad embrionaria. [cite: 87]',
        recommendations: [
    ...
    IMC_OBESIDAD_II: {
        explanation: 'Tu IMC indica Obesidad Clase II. La obesidad reduce la respuesta ovárica a la estimulación y la calidad embrionaria. [cite: 88]',
        recommendations: [
    ...
    IMC_OBESIDAD_III: {
        explanation: 'Tu IMC indica Obesidad Clase III. Este grado de obesidad tiene un impacto muy significativo en la fertilidad, respuesta a tratamientos y riesgo gestacional. [cite: 88]',
        recommendations: [
    ...
    // --- AMH ---
    AMH_ALTA_RESERVA: {
        explanation: 'Tienes una alta reserva ovárica. Valores muy altos pueden sugerir SOP. La AMH refleja la cantidad de folículos antrales disponibles. [cite: 96]',
        recommendations: [
    ...
    AMH_BAJA: {
        explanation: 'Tu reserva ovárica es baja. Esto predice una menor respuesta ovárica a la estimulación. [cite: 95]',
        recommendations: [
    ...
    AMH_MUY_BAJA: {
        explanation: 'Tu reserva ovárica es muy baja. Esto predice una respuesta ovárica pobre o nula a la estimulación. [cite: 95]',
        recommendations: [
    ...
    // --- Miomatosis Uterina ---
    MIOMA_SUBMUCOSO: {
        explanation: 'Se ha detectado un mioma submucoso o intramural que distorsiona la cavidad uterina. Estos miomas reducen la tasa de implantación y duplican el riesgo de aborto. [cite: 102]',
        recommendations: [
    ...
    MIOMA_INTRAMURAL_GRANDE: {
        explanation: 'Se ha detectado un mioma intramural grande (≥ 4 cm) sin distorsión de la cavidad. Estos pueden reducir la tasa de nacidos vivos. [cite: 103]',
        recommendations: [
    ...
    MIOMA_SUBSEROSO: {
        explanation: 'Se ha detectado un mioma subseroso aislado. Generalmente, no tiene un impacto significativo en la fertilidad. [cite: 104]',
        recommendations: [
    ...
    POLIPO_PEQUENO: {
        explanation: 'Se ha detectado un pólipo endometrial pequeño único (< 1 cm). Los pólipos pueden interferir mecánicamente con la implantación. [cite: 108]',
        recommendations: [
    ...
    POLIPO_GRANDE: {
        explanation: 'Se ha detectado un pólipo endometrial grande (> 1 cm) o múltiples. Pueden interferir significativamente con la implantación. [cite: 108]',
        recommendations: [
    ...
    POLIPO_OSTIUM: {
        explanation: 'Se ha detectado un pólipo sobre el ostium tubárico o recurrente. Esto puede causar obstrucción y reducir drásticamente la probabilidad de fecundación. [cite: 108]',
        recommendations: [
    ...
    // --- Adenomiosis ---
    ADENOMIOSIS: {
        explanation: 'Se ha detectado adenomiosis. Esta condición reduce la probabilidad de implantación y puede incrementar el riesgo de aborto por alteración de la receptividad endometrial. [cite: 114]',
        recommendations: [
    ...
    ADENOMIOSIS_FOCAL: {
        explanation: 'Se ha detectado adenomiosis focal. Esta condición reduce la probabilidad de implantación y puede incrementar el aborto. [cite: 114]',
        recommendations: [
    ...
    ADENOMIOSIS_DIFUSA: {
        explanation: 'Se ha detectado adenomiosis difusa. El compromiso miometrial generalizado reduce significativamente la implantación y eleva el riesgo de aborto. [cite: 115]',
        recommendations: [
    ...
    // --- Endometriosis ---
    ENDOMETRIOSIS_LEVE: {
        explanation: 'Endometriosis leve (Grados I-II). Incluso estas formas pueden alterar la implantación debido a la inflamación peritoneal crónica. [cite: 122]',
        recommendations: [
    ...
    ENDOMETRIOSIS_SEVERA: {
        explanation: 'Endometriosis severa (Grados III-IV). Afecta la fertilidad por daño anatómico, inflamación y reducción de calidad ovocitaria. [cite: 121]',
        recommendations: [
    ...
    // --- Ciclo Menstrual ---
    CICLO_REGULAR: {
        explanation: 'Tu ciclo menstrual es regular, lo que sugiere una ovulación predecible. La probabilidad de ovulación espontánea mensual supera el 90%. [cite: 129]',
    ...
    CICLO_IRREGULAR_LEVE: {
        explanation: 'Tienes un ciclo menstrual irregular leve. Esto puede indicar ovulación esporádica o disfunción ovulatoria. [cite: 128]',
    ...
    CICLO_IRREGULAR_MARCADO: {
        explanation: 'Tienes un ciclo menstrual marcadamente irregular, lo que indica una alta probabilidad de anovulación crónica. [cite: 128]',
        recommendations: [
    ...
    // --- SOP ---
    SOP: {
        explanation: 'Tienes diagnóstico de Síndrome de Ovario Poliquístico (SOP). Es una de las causas más comunes de infertilidad anovulatoria y requiere manejo integral. [cite: 136]',
        recommendations: [
    ...
    SOP_LEVE: {
        explanation: 'Tienes un fenotipo de SOP leve, con ovulación preservada o AMH <6 ng/mL. Es una de las causas más comunes de infertilidad anovulatoria. [cite: 136]',
        recommendations: [
    ...
    SOP_MODERADO: {
        explanation: 'Tienes un fenotipo de SOP moderado, con anovulación o AMH >6 ng/mL. El entorno endocrino desfavorable y la resistencia a la insulina alteran la receptividad endometrial. [cite: 137]',
        recommendations: [
    ...
    SOP_SEVERO: {
        explanation: 'Tienes un fenotipo de SOP severo, con anovulación, IMC >30 o HOMA >3.5. Hay una resistencia significativa a los tratamientos orales. [cite: 134]',
        recommendations: [
    ...
    // --- HSG ---
    HSG_NORMAL: {
        explanation: 'Tu Histerosalpingografía (HSG) muestra trompas permeables bilaterales sin alteraciones. Esto es favorable para la concepción natural. [cite: 143]',
        recommendations: [
    ...
    HSG_UNILATERAL: {
        explanation: 'Tienes una obstrucción tubárica unilateral (una trompa obstruida o hidrosálpinx unilateral). Esto reduce la probabilidad de embarazo espontáneo en ~20-30%. [cite: 145]',
        recommendations: [
    ...
    HSG_BILATERAL: {
        explanation: 'Tienes una obstrucción tubárica bilateral (ambas trompas obstruidas o hidrosálpinx bilateral). Esto impide el paso de ovocitos y espermatozoides. [cite: 144]',
        recommendations: ['FIV directa es la única opción para el embarazo. [cite: 147]'],
        sources: ['DOI: 10.1016/j.fertnstert.2020.12.010 [cite: 145]'],
    },
    HSG_MALFORMACION: {
        explanation: 'Se ha detectado una malformación uterina relevante (ej. útero septado o unicorne). Esto puede afectar la implantación y el desarrollo del embarazo. [cite: 142]',
        recommendations: [
    ...
    OTB_PRESENTE: {
        explanation: 'Tienes una ligadura de trompas (OTB) bilateral, lo que elimina la posibilidad de embarazo espontáneo. [cite: 150]',
        recommendations: [
    ...
    PRL_LEVE: {
        explanation: 'Tienes hiperprolactinemia leve. La hiperprolactinemia puede inhibir la hormona GnRH y bloquear la ovulación. [cite: 156]',
    ...
    PRL_SIGNIFICATIVA: {
        explanation: 'Tienes hiperprolactinemia significativa. Niveles > 50 ng/mL suelen asociarse con amenorrea o anovulación. [cite: 157]',
        recommendations: [
    ...
    TSH_LIMITE_SUPERIOR: {
        explanation: 'Tu nivel de TSH está en el límite superior del rango aceptable para fertilidad (2.5-4.0 mUI/L). El hipotiroidismo subclínico puede asociarse a ciclos anovulatorios y mayor riesgo de aborto. [cite: 161]',
    ...
    TSH_HIPOTIROIDISMO: {
        explanation: 'Tu nivel de TSH indica hipotiroidismo (> 4.0 mUI/L). Esto se asocia a ciclos anovulatorios, aumento del aborto y menor tasa de implantación. [cite: 161]',
        recommendations: [
    ...
    // --- TPOAb ---
    TPOAB_POSITIVO: {
        explanation: 'Tienes anticuerpos antitiroideos (TPOAb) positivos. Esto se asocia con mayor riesgo de aborto espontáneo y menor tasa de nacidos vivos, incluso con TSH normal. [cite: 165]',
        recommendations: [
    ...
    HOMA_LEVE: {
        explanation: 'Tienes leve resistencia a la insulina. Esto puede alterar el eje gonadal y la receptividad endometrial. [cite: 169]',
        recommendations: [
    ...
    HOMA_SIGNIFICATIVA: {
        explanation: 'Tienes resistencia a la insulina significativa. Esto reduce la ovulación espontánea, la receptividad endometrial y eleva el riesgo de aborto, especialmente en SOP. [cite: 169]',
        recommendations: [
    ...
    INFERTILIDAD_PROLONGADA: {
        explanation: 'Tienes 5 o más años de infertilidad. Esto sugiere una alta probabilidad de patología múltiple o subyacente. [cite: 174]',
    ...
    FACTOR_MASCULINO_LEVE: {
        explanation: 'Se detecta factor masculino leve: oligozoospermia leve (10-15 mill/mL), astenozoospermia leve (30-40% motilidad) o teratozoospermia leve (3-4% formas normales). [cite: 181]',
        recommendations: [
    ...
    FACTOR_MASCULINO_MODERADO: {
        explanation: 'Se detecta factor masculino moderado: oligozoospermia moderada (5-10 mill/mL), astenozoospermia moderada (20-30% motilidad) o teratozoospermia moderada (1-3% formas normales). [cite: 182]',
        recommendations: [
    ...
    FACTOR_MASCULINO_SEVERO: {
        explanation: 'Se detecta factor masculino severo: oligozoospermia severa (<5 mill/mL), astenozoospermia severa (<20% motilidad), teratozoospermia severa (<1% formas normales) o criptozoospermia. [cite: 183]',
        recommendations: [
    ...
    FACTOR_MASCULINO_AZOOSPERMIA: {
        explanation: 'Se detecta azoospermia: ausencia completa de espermatozoides en eyaculado tras centrifugación. Puede ser obstructiva o no obstructiva. [cite: 184]',
        recommendations: [
    ...
    CIRUGIA_PELVICA_UNA: {
        explanation: 'Tienes el antecedente de 1 cirugía pélvica previa. Las cirugías pélvicas aumentan la probabilidad de adherencias y daño tubárico. [cite: 179]',
    ...
    CIRUGIA_PELVICA_MULTIPLE: {
        explanation: 'Tienes el antecedente de 2 o más cirugías pélvicas. Esto eleva significativamente la probabilidad de adherencias, disrupción anatómica y falla tubárica oculta. [cite: 179]',
        recommendations: [
    ...
    MALE_OLIGOZOOSPERMIA: {
        explanation: 'Se ha detectado Oligozoospermia (concentración <16 M/mL). La concentración seminal es clave para la fecundación. [cite: 183]',
    ...
    MALE_ASTENOZOOSPERMIA: {
        explanation: 'Se ha detectado Astenozoospermia (motilidad progresiva <30%). La motilidad es fundamental para que los espermatozoides lleguen al óvulo. [cite: 183]',
    ...
    MALE_TERATOZOOSPERMIA: {
        explanation: 'Se ha detectado Teratozoospermia (morfología normal <4%). La morfología normal es importante para la fecundación y la calidad embrionaria. [cite: 183]',
    ...
    // Interacción 1
    INT_EDAD_AMH_BAJA: {
        explanation: 'La combinación de edad avanzada (≥38 años) y una reserva ovárica baja (AMH <0.8 ng/mL) predice un menor número de ovocitos recuperados (<4 en 65–80 % de los casos) y una mayor proporción de aneuploidías (≥ 70 %), con una fecundidad espontánea muy baja (<3% por ciclo). ',
        recommendations: [
    ...
    // Interacción 2
    INT_SOP_IR: {
        explanation: 'La combinación de SOP con resistencia a la insulina significativa (HOMA-IR ≥3.5) se asocia a menor tasa de ovulación con tratamientos orales, baja receptividad endometrial y mayor riesgo de aborto precoz. [cite: 4]',
        recommendations: [
    ...
    INT_ENDO_AVANZADA_MASCULINO: {
        explanation: 'La endometriosis severa (Grados III-IV) combinada con un factor masculino anormal reduce drásticamente la fertilidad espontánea debido a un doble factor anatómico y gamético. La tasa de embarazo espontáneo es <2% anual. [cite: 6]',
        recommendations: [
    ...
    INT_HSG_UNILATERAL_SEMINAL: {
        explanation: 'Aunque una trompa permeable puede permitir embarazo, la calidad espermática baja disminuye significativamente la fecundidad conjunta. No se recomienda inducción ni inseminación intrauterina en este escenario si se lleva >12 meses de intento. [cite: 9]',
        recommendations: [
    ...
    INT_EDAD40_FALLO_OVARICO: {
        explanation: 'Este perfil (Edad ≥40, AMH <0.3, y ciclos muy irregulares) sugiere un fallo ovárico inminente. La tasa de ovocitos euploides es <3% y la respuesta a FIV con óvulos propios es nula o pobre. [cite: 12]',
        recommendations: [
    ...
    INT_SOP_IMC_OBESIDAD_SEVERA: {
        explanation: 'La combinación de SOP y obesidad severa (IMC ≥35) se asocia a hiperinsulinismo crónico, mayor tasa de fallos de inducción ovulatoria y un riesgo de aborto >2.5x. La tasa de implantación en FIV es baja. [cite: 15]',
        recommendations: [
    ...
    INT_MIOMA_SUBMUCOSO_ENDO_LEVE: {
        explanation: 'Aunque ambas patologías por separado son tratables, la coexistencia de un mioma submucoso y endometriosis leve (I-II) interfiere mecánica e inflamatoriamente con la implantación, reduciendo las tasas de nacidos vivos tras FIV si no se corrigen quirúrgicamente. [cite: 17]',
        recommendations: [
    ...
    INT_ADENOMIOSIS_DIFUSA_EDAD_AVANZADA: {
        explanation: 'La combinación de adenomiosis difusa y edad avanzada (≥38 años) reduce significativamente la implantación y eleva el riesgo de aborto. Las tasas de FIV exitosas sin tratamiento hormonal previo son <15% en mujeres ≥ 38 años con adenomiosis difusa. [cite: 20]',
        recommendations: [
    ...
    INT_INFERTILIDAD_LARGA_CIRUGIAS_MULTIPLES: {
        explanation: 'El tiempo prolongado sin concepción (≥5 años) y la presencia de múltiples cirugías pélvicas (≥2) elevan la probabilidad de adherencias, disrupciones anatómicas y falla tubárica oculta. La probabilidad de embarazo espontáneo en esta población es <5% anual. [cite: 23]',
        recommendations: [
            'FIV directa. [cite: 24]',
    ...
    INT_TSH_ALTA_TPOAB_POSITIVOS: {
        explanation: 'Las pacientes con hipotiroidismo clínico y tiroiditis autoinmune (TSH > 4.0 y TPOAb positivos) tienen reducción de ovulación espontánea, mayor riesgo de aborto (RR ~2.0) y trastornos de implantación. [cite: 27]',
        recommendations: [
    ...
    INT_AMH_FSH_EDAD_CRITICA: {
        explanation: 'Esta tríada (AMH <0.5, FSH >12, Edad ≥40) indica reserva ovárica severamente comprometida con disfunción folicular central. Las tasas de recuperación de ovocitos euploides son <2%, y las tasas de nacidos vivos con óvulos propios en FIV son <5%. [cite: 28]',
        recommendations: [
    ...
    INT_OTB_EDAD_AVANZADA: {
        explanation: 'Tras los 37 años, la reserva ovárica disminuye y el éxito de recanalización es muy bajo (<20% nacidos vivos). FIV ofrece mayor tasa de éxito, menor tiempo y evita riesgos quirúrgicos. [cite: 31]',
        recommendations: [
    ...
    INT_SOP_CICLOS_PRL_ALTAS: {
        explanation: 'La hiperprolactinemia (Prolactina >50 ng/mL) agrava la anovulación del SOP e interfiere con receptividad endometrial. Puede ser signo de adenoma hipofisario funcional en este contexto. [cite: 35]',
        recommendations: [
    ...
    INT_AMH_BAJA_TERATOZOOSPERMIA: {
        explanation: 'La combinación de baja reserva ovárica (AMH <1.0) y teratozoospermia severa (<2% morfología normal) afecta la fertilización (tasas <40% en FIV convencional) y la calidad embrionaria, con alta tasa de ciclo cancelado. [cite: 39]',
        recommendations: [
    ...
    INT_ENDO_AVANZADA_EDAD_AMH_BAJA: {
        explanation: 'Este perfil (Endometriosis III–IV, Edad >39, AMH <1.0) predice baja respuesta ovárica, inflamación pélvica crónica, riesgo de fallo tubario y edad materna límite. Tasa de nacidos vivos por intento espontáneo <2%, por FIV <10% sin vitrificación precoz. [cite: 41]',
        recommendations: [
    ...
    INT_PERFIL_HIERESPONDEDOR_JOVEN_SOP_ESTABLE: {
        explanation: 'Aunque el SOP puede causar anovulación, este fenotipo joven con alta reserva (AMH >4.5) y semen normal, y SOP metabólicamente estable (HOMA-IR <2.0, TSH óptimo), presenta un buen pronóstico con cambios de estilo de vida e inducción ovulatoria. [cite: 45]',
        recommendations: [
    ...
    INT_ENDO_LEVE_AMH_NORMAL_JOVEN: {
        explanation: 'Pacientes jóvenes (Edad <35) con endometriosis leve (I–II) y reserva ovárica normal (AMH >1.5) tienen buenas tasas de embarazo espontáneo y por FIV si se trata la enfermedad y se mantiene función ovárica. [cite: 48]',
        recommendations: [
    ...
    INT_HSG_UNILATERAL_JOVEN_SEMEN_NORMAL: {
        explanation: 'Una trompa permeable funcional, buen esperma y edad joven (<35) permite una tasa de embarazo espontáneo aceptable (~20% por año). FIV no es de primera línea. [cite: 51]',
        recommendations: [
    ...
    INT_POLIPO_PEQUENO_JOVEN_FAVORABLE: {
        explanation: 'Pólipos endometriales pequeños (<1 cm) tienen bajo impacto aislado. Su resección mejora la tasa de implantación (~18%) incluso en mujeres sin FIV. [cite: 52]',
        recommendations: [
    ...
    INT_EDAD_AMH_SOP_HOMA_TSH_OPTIMO: {
        explanation: 'Pacientes jóvenes (Edad <30) con SOP y sin Resistencia a la Insulina (HOMA-IR <2.0) ni disfunción tiroidea (TSH óptimo) tienen alta tasa de ovulación inducida y elevada respuesta a FIV (≥15 ovocitos promedio), con buena tasa de embarazo por intento. [cite: 56]',
        recommendations: [
...
PremiumCacheManager.cache = new Map();
PremiumCacheManager.maxSize = 1000;
/**
...
export class PremiumPatternAnalyzer {
    static analyzeComplexInteractions(factors) {
    ...
    static calculateAdvancedRiskScore(factors) {
    ...
    static detectComplexInteractions(factors) {
        const interactions = [];
    ...
    static generatePremiumRecommendations(factors, interactions) {
        const recommendations = [];
        // Recomendaciones premium ultra-específicas
        if (interactions.some(i => i.includes('SOP + Resistencia'))) {
            recommendations.push('PROTOCOLO SOP+RI PREMIUM: Metformina 1000mg BID + Mio-inositol 2g BID + D-chiro-inositol 600mg/día', 'Letrozol 5mg x5 días con monitoring ecográfico CD12, trigger hCG si folículo ≥18mm', 'Optimización metabólica 3-4 meses pre-concepción con dieta DASH modificada');
        }
        if (interactions.some(i => i.includes('Endometriosis + Adenomiosis'))) {
            recommendations.push('PROTOCOLO ANTIINFLAMATORIO PREMIUM: GnRH agonista 3 meses + HBPM profiláctica', 'Aspirina 100mg/día + Omega-3 2g/día + Vitamina D 4000 UI/día', 'FIV con transferencia diferida post-supresión hormonal');
        }
        if (interactions.some(i => i.includes('Baja reserva + Edad'))) {
            recommendations.push('PROTOCOLO RESERVA CRÍTICA: DHEA 75mg/día + CoQ10 600mg/día x 3 meses', 'Estimulación máxima: rFSH 300-450 UI + HMG con protocolo antagonista', 'Banking de ovocitos urgente con PGT-A si edad ≥38 años');
        }
        return recommendations;
    }
}
// Helper function para calcular dosis de metformina
function getMetforminDose(severity) {
    if (severity === 'mild')
        return '500mg';
...
export class PremiumPharmacologyEngine {
    static generateDetailedProtocol(condition, severity) {
        const protocols = {
        ...
        return protocols[condition] || this.getDefaultProtocol();
    }
    static getPCOSProtocol(severity) {
    ...
    static getEndometriosisProtocol(severity) {
        return {
            medications: [
                {
    ...
    static getAdenomiosisProtocol(severity) {
        const protocol = {
            medications: [
                {
                    name: 'GnRH Agonista (Triptorelina)',
    ...
    static getLowAMHProtocol(severity) {
        return {
            medications: [
                {
                    name: 'DHEA',
    ...
    static getInsulinResistanceProtocol(severity) {
        const metforminDose = getMetforminDose(severity);
...
export class PremiumMetricsEngine {
    ...
    static trackPremiumUsage(feature) {
...
export class PremiumAuthManager {
    static validatePremiumAccess(userTier) {
        return ['premium', 'professional', 'enterprise'].includes(userTier.toLowerCase());
    }
    static getPremiumFeatures(userTier) {
        const features = {
            'premium': [
