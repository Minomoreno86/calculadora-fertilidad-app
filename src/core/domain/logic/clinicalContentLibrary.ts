...
export const clinicalContentLibrary: Record<string, ClinicalInfo> = {
  ...
  ENDOMETRIOSIS: {
    explanation:
      'La endometriosis es una condición inflamatoria donde el tejido endometrial crece fuera del útero. Puede afectar la fertilidad por distorsión anatómica, inflamación pélvica crónica o alteración de la calidad ovocitaria.',
    recommendations: [
  ...
  MIOMAS: {
    explanation:
      'Los miomas submucosos y los intramurales de gran tamaño (>4 cm) pueden reducir las tasas de implantación y aumentar el riesgo de pérdida gestacional al alterar la cavidad uterina o su vascularización.',
    recommendations: [
  ...
  POLIPOS: {
    explanation:
      'Los pólipos son crecimientos benignos en el endometrio que pueden interferir con la implantación del embrión. Su presencia reduce las tasas de embarazo espontáneo y por FIV.',
    recommendations: [
  ...
  PRL_ALTA: {
    explanation:
      'Niveles elevados de prolactina inhiben la ovulación al alterar la secreción hormonal. Puede deberse a estrés, medicamentos o adenomas hipofisarios. Es una causa reversible de infertilidad.',
    recommendations: [
  ...
  CICLO_IRREGULAR: {
    explanation:
      'Los ciclos menstruales irregulares reflejan una alteración en la ovulación. Son comunes en trastornos hormonales como el SOP o disfunción tiroidea, y reducen la probabilidad de concebir.',
    recommendations: [
  ...
  TSH_ALTA: {
    explanation:
      'Un nivel de TSH superior a 2.5 µIU/mL, incluso dentro del rango normal general, puede afectar la ovulación, la calidad ovocitaria y la implantación.',
    recommendations: [
  ...
  HOMA_ALTO: {
    explanation:
      'El índice HOMA-IR > 2.5 sugiere resistencia a la insulina, la cual puede afectar negativamente la ovulación y el ambiente endometrial, y se asocia a menor tasa de implantación.',
    recommendations: [
