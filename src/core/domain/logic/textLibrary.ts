...
export const RECOMENDACIONES: Record<string, string> = {
  ...
  EDAD_43:
    'Edad >43a: La probabilidad de concepción espontánea es extremadamente baja. Se recomienda consultar directamente opciones como la ovodonación.',
  CICLO_IRREGULAR:
    'Los ciclos irregulares pueden ser un signo de problemas de ovulación y requieren un estudio hormonal para determinar la causa.',
  IMC_BAJO: 'IMC: Optimizar nutrición para alcanzar un peso saludable y regularizar la ovulación.',
  IMC_ALTO:
    'IMC: Iniciar plan de dieta y ejercicio. Una pérdida del 5% del peso puede mejorar significativamente la fertilidad.',
  SOP: 'SOP: Consultar sobre inducción de la ovulación (ej. Letrozol) como tratamiento de primera línea.',
  ENDO_LEVE:
    'Endometriosis Grado I-II: Puede intentarse concepción espontánea/dirigida, valorar tratamiento si no hay éxito.',
  ENDO_SEVERA:
    'Endometriosis Grado III-IV: Se recomienda valoración directa para FIV, ya que el pronóstico espontáneo es bajo.',
  ...
  ADENO_DIFUSA:
    'Adenomiosis Difusa: Se recomienda valoración para FIV, ya que la fertilidad espontánea está muy reducida.',
  POLIPO:
    'Pólipo Endometrial: Se recomienda resección por histeroscopia (polipectomía) para optimizar la cavidad endometrial.',
  HSG_UNILATERAL:
    'HSG - Obstrucción Unilateral: Considerar seguimiento folicular para dirigir relaciones al lado permeable.',
  ...
  PRL_ALTA:
    'Prolactina Elevada: Requiere tratamiento con agonistas dopaminérgicos (ej. Cabergolina) y estudio por endocrinólogo.',
  TSH_ALTA:
    'TSH no óptima para fertilidad (<2.5): Se recomienda tratamiento de sustitución y control por endocrinólogo.',
  TPO_POSITIVO:
    'TPO-Ab Positivo: Autoinmunidad tiroidea presente. Requiere seguimiento estricto durante el embarazo por riesgo de aborto.',
  HOMA_ALTO: 'HOMA - Resistencia a la insulina: Priorizar cambios en estilo de vida y valorar uso de metformina.',
  FACTOR_MASCULINO:
    'Factor Masculino: Hallazgos alterados en espermatograma. Se recomienda consulta con Andrólogo/Urólogo.',
};
