...
export const evaluateEndometriosis = (grado: number): Partial<EvaluationState> => {
  if (grado === 0) return {};
...
export const evaluateMyomas = (tiene_miomas: boolean, submucoso: boolean, intramural: boolean): Partial<EvaluationState> => {
