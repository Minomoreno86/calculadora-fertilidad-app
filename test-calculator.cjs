...
const { AbortionRiskCalculator } = require('./dist/calculators/AbortionRiskCalculator');
const { SmokingStatus, AlcoholConsumption } = require('./dist/models/AbortionRiskModels');
