...
try {
  ...
  const hasNeuralAnalysis = aiConsultationContent.includes('neuralAnalysis') || aiConsultationContent.includes('setNeuralAnalysis');
  const hasNeuralSection = aiConsultationContent.includes('renderNeuralSupeIntelligenceSection') || aiConsultationContent.includes('Neural Superinteligente');
